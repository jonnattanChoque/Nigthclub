...
class DashboardHandlers {
  ...
  static Handler categories = Handler(handlerFunc: (context, params) {
    final authProvider = Provider.of<AuthProvider>(context!);
    Provider.of<SideMenuProvider>(context, listen: false).setCurrentpageUrl(Flurorouter.categoriesRouter);
    if(authProvider.authStatus == AuthStatus.authenticated) {
  ...
  static Handler newProduct = Handler(handlerFunc: (context, params) {
    final authProvider = Provider.of<AuthProvider>(context!);
    Provider.of<SideMenuProvider>(context, listen: false).setCurrentpageUrl(Flurorouter.newProductRouter);
    if(authProvider.authStatus == AuthStatus.authenticated) {
  ...
  static Handler card = Handler(handlerFunc: (context, params) {
    final authProvider = Provider.of<AuthProvider>(context!);
    Provider.of<SideMenuProvider>(context, listen: false).setCurrentpageUrl(Flurorouter.cardRouter);
    if(authProvider.authStatus == AuthStatus.authenticated) {
  ...
  static Handler orders = Handler(handlerFunc: (context, params) {
    final authProvider = Provider.of<AuthProvider>(context!);
    Provider.of<SideMenuProvider>(context, listen: false).setCurrentpageUrl(Flurorouter.ordersRouter);
    if(authProvider.authStatus == AuthStatus.authenticated) {
  ...
  static Handler sales = Handler(handlerFunc: (context, params) {
    final authProvider = Provider.of<AuthProvider>(context!);
    Provider.of<SideMenuProvider>(context, listen: false).setCurrentpageUrl(Flurorouter.salesRouter);
    if(authProvider.authStatus == AuthStatus.authenticated) {
  ...
  static Handler salesToday = Handler(handlerFunc: (context, params) {
    final authProvider = Provider.of<AuthProvider>(context!);
    Provider.of<SideMenuProvider>(context, listen: false).setCurrentpageUrl(Flurorouter.salesTodayRouter);
    if(authProvider.authStatus == AuthStatus.authenticated) {
  ...
  static Handler salesMonth = Handler(handlerFunc: (context, params) {
    final authProvider = Provider.of<AuthProvider>(context!);
    Provider.of<SideMenuProvider>(context, listen: false).setCurrentpageUrl(Flurorouter.salesMonthRouter);
    if(authProvider.authStatus == AuthStatus.authenticated) {
  ...
  static Handler  notes = Handler(handlerFunc: (context, params) {
    final authProvider = Provider.of<AuthProvider>(context!);
    Provider.of<SideMenuProvider>(context, listen: false).setCurrentpageUrl(Flurorouter.notesRouter);
    if(authProvider.authStatus == AuthStatus.authenticated) {
